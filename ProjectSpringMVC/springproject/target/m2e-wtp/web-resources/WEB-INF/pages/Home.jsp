		...
		<table class="table table-striped">
			...
			<c:forEach var="contact" items="${listeContact}">
				<TR>
					...
					<td><c:out
							value="${contact.adresse.numero}, ${contact.adresse.rue}, ${contact.adresse.codePostal}, ${contact.adresse.ville}<br>${contact.adresse.numero}, ${contact.adresse.rue}, ${contact.adresse.codePostal}, ${contact.adresse.ville}"></c:out></td>
